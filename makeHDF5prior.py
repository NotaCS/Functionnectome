...
def run_h5maker(outFile, templatePath, dirVoxel, dirRegion, maskRegion):
    ...
    with h5py.File(outFile, "a") as h5fout:
        ...
        template = h5fout.create_dataset('template', template_img.shape,
                                         template_img.get_data_dtype(), compression="gzip")
...
if __name__ == '__main__':
    ...
    run_h5maker(outFile, templatePath, dirVoxel, dirRegion, maskRegion)
